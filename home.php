...
<body class="index-page">
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="about.php">CONTACT US</a></li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="index.html" title="Logout" onclick="return confirm('Logout? ');">
    ...
    <section class="hero">
      <main class="content">
        ...
        <div class="clear"></div>
        <p>25% Off On All Product</p>
        <a href="#" class="btn btn-primary">GO SHOP NOW</a>
      </main>
    </section>
    <!-- hero End -->
    <!-- Marquee Start -->
