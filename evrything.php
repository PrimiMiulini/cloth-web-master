...
$limit = 12; // Jumlah item per halaman
...
$totalItems = getProductCount($keyword);
$totalPages = ceil($totalItems / $limit);

$product = cari($keyword, '', $limit, $offset);
$totalItems = getProductCount($keyword);
?>
...
<head>
    ...
    <!-- Local css -->
    <link rel="stylesheet" href="css/evrything.css">
    <!-- data aos -->
...
<body>
    ...
    <main id="main" class="main">
      <div data-aos="flip-right" data-aos-delay="100" data-aos-offset="50" data-aos-duration="1500" class="container shadow-lg p-2 mb-2">
        <div class="row d-flex flex-row text-center">
          <div class="col-3">
            <form action="" class="d-flex" role="search" method="post">
              <input class="form-control me-2" type="search" placeholder="Keyword" aria-label="Search" autocomplete="off" name="keyword">
    ...
    <section id="product" class="product"> 
      <div class="row">
        ...
        foreach ($product as $prd) : ?>
          <div data-aos="flip-up" data-aos-delay="100" data-aos-offset="250" data-aos-duration="1500" class="col-md-3">
